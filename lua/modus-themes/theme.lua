...
function M.setup()
	...
	theme.highlights = {
		...
		NeogitHunkHeader = { fg = c.fg_main, bg = c.bg_inactive },
		NeogitHunkHeaderHighlight = { fg = c.fg_active, bg = c.bg_status_line_inactive },
		NeogitHunkHeaderCursor = { fg = c.fg_active, bg = c.bg_status_line_inactive },
		NeogitDiffContext = { bg = c.none },
		NeogitDiffContextHighlight = { bg = c.none, fg = c.fg_dim },
		NeogitDiffContextCursor = { bg = c.bg_hl_line },
		NeogitDiffDelete = { bg = c.bg_removed, fg = c.fg_removed },
		NeogitDiffDeleteHighlight = { bg = c.bg_removed, fg = c.fg_removed_intense },
		NeogitDiffDeleteCursor = { bg = c.bg_removed, fg = c.fg_removed_intense },
		NeogitDiffDeleteInline = { bg = c.bg_red_intense, fg = c.fg_main },
		NeogitDiffAdd = { bg = c.bg_added, fg = c.fg_added },
		NeogitDiffAddHighlight = { bg = c.bg_added, fg = c.fg_added_intense },
		NeogitDiffAddCursor = { bg = c.bg_added, fg = c.fg_added_intense },
		NeogitDiffAddInline = { bg = c.bg_green_intense, fg = c.fg_main },
		NeogitSectionHeader = { fg = c.blue, bold = true },
		NeogitChangeModified = { fg = c.blue_faint, bold = true, italic = true },
		NeogitChangeAdded = { fg = c.fg_added, bold = true, italic = true },
		NeogitChangeDeleted = { fg = c.fg_removed, bold = true, italic = true },
		NeogitChangeNewFile = { fg = c.fg_added, bold = true, italic = true },
		NeogitChangeRenamed = { fg = c.blue_faint, bold = true, italic = true },
		NeogitChangeUnmerged = { fg = c.yellow_faint, bold = true, italic = true },
