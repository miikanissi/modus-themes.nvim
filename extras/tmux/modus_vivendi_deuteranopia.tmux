...
set-option -g status-style bg=#2a2a6a,fg=#f0f0f0
set-option -g status-left '#[bg=#2a2a6a,fg=#f0f0f0,bold]#{?client_prefix,,  tmux  }#[bg=#79a8ff,fg=#1e1e1e,bold]#{?client_prefix,  tmux  ,}'
